import 'package:clients/Animations/FadeAnimation.dart';
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  FadeAnimation(1, Text("Bienvenu(e)",
                    style: TextStyle(color: Colors.white, fontSize: 50),)),
                  SizedBox(height: 15,),
                  FadeAnimation(1.3, Text("Commencez un nouveau projet, commencez une nouvelle expérience",
